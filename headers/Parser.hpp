...
#line 232 "headers/Parser.hpp"
    ...
    OR = 291,                      // OR
    AND = 292,                     // AND
    MAYOR_QUE = 293,               // MAYOR_QUE
    MENOR_QUE = 294,               // MENOR_QUE
    MAYOR_IGUAL = 295,             // MAYOR_IGUAL
    MENOR_IGUAL = 296,             // MENOR_IGUAL
    NO_IGUAL = 297,                // NO_IGUAL
    IGUAL = 298                    // IGUAL
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_OR = 36,                               // OR
        S_AND = 37,                              // AND
        S_MAYOR_QUE = 38,                        // MAYOR_QUE
        S_MENOR_QUE = 39,                        // MENOR_QUE
        S_MAYOR_IGUAL = 40,                      // MAYOR_IGUAL
        S_MENOR_IGUAL = 41,                      // MENOR_IGUAL
        S_NO_IGUAL = 42,                         // NO_IGUAL
        S_IGUAL = 43,                            // IGUAL
